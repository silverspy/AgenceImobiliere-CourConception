...
/**
 * Classe Agence.Agence immobiliere
 * une agence est constitue d une liste de Agence.RDV,d annonce,de bien a vendre ainsi que d'une liste
...
public class Agence {
    ...
    public Agence(ArrayList<Annonce> lA, ArrayList<RDV> lRDV, ArrayList<BienImmobilier> lBI) {
        if (lBI.size() >= 1 && lRDV.size() >= 1) {
            ...
            if (lRDV.size() < 1) {
                throw new IllegalArgumentException("Agence.Agence initialisee sans rendez vous");
            }
            if (lBI.size() < 1) {
                throw new IllegalArgumentException("Agence.Agence initialisee sans Bien Immobillier");
            }
        }
    }
    ...
    /**
     * ajoute un Agence.RDV pour signer un mandat a la liste des Agence.RDV
     *
     * @param dateRDV       la date du Agence.RDV
    ...
    void prendreRDVMandat(Date dateRDV, BienImmobilier b, Personne p, Date dateFinMandat) {
        this.listRDV.add(new RDV(dateRDV, b, p, "Agence.Mandat", dateFinMandat));

    }


    /**
     * inscrit une personne Personne.Morale pour la vente d un terrain.
     * Ajoute la personne a la liste des vendeurs le terrain dans la liste des bien et creer un rdv pour signer un mandat et l ajoute a la liste des Agence.RDV
     *
    ...
    private void checkVoeux(BienImmobilier b) {
        ...
        if (b instanceof Maison) {
            ...
            System.out.println("lance checkVoeux BienImmobilier.Appart");
            checkVoeuxAppart(b);
        } else {
    ...
    /**
     * Menu permettant d'inscrire une personne Personne.Morale ou physique sur la liste des acheteurs potentiels
     *
     * @see Morale
     * @see Physique
     */
    private void menuAchat() {
        ...
        menu += "Pt- Inscription d'une personne Personne.Physique interressee par un terrain\n";
        menu += "Pa- Inscription d'une personne Personne.Physique interressee par un appartement\n";
        menu += "Pm- Inscription d'une personne Personne.Physique interresse par une maison\n";
        menu += "Q- Quitter\n";
    ...
    private void menuInscriptionVente() {
        ...
        menu += "Pt- Inscription d'une personne Personne.Physique pour un terrain\n";
        menu += "Pa- Inscription d'une personne Personne.Physique pour un appartement\n";
        menu += "Pm- Inscription d'une personne Personne.Physique pour une maison\n";
        menu += "Q- Quitter\n";
        boolean fin = false;
        while (fin == false) {
            System.out.println(menu);
            ...
            switch (str) {
                case "Pa":
                    ...
                    Date dateFinMandat = this.entrerDate("Fin de Agence.Mandat");
                    Date dateRDV = this.entrerDate("Agence.RDV");
                ...
                case "Ma":
                    ...
                    Date dateRDV1 = this.entrerDate("Date de Agence.RDV");
                ...
                case "Pt":
                    ...
                    Date dateRDV2 = this.entrerDate("Date de Agence.RDV");
                ...
                case "Mt":
                    ...
                    Date dateRDV3 = this.entrerDate("de Agence.RDV");
                ...
                case "Pm":
                    ...
                    Date dateFinMandat4 = this.entrerDate("Fin de Agence.Mandat");
                    Date dateRDV4 = this.entrerDate("De Agence.RDV");
                ...
                case "Mm":
                    ...
                    Date dateRDV5 = this.entrerDate("Agence.RDV");
                ...
                if (p.getBienSoumis().indexOf(b) == -1) {
                    ...
                    if (m.getLocalistation() == v.getLocalisation() && m.getNbPieces() == v.getNbPieces() && m.getSurfaceSol() == v.getSurfacesSol()) {
                        ...
                        if (m.getPrix() >= borneBasse && m.getPrix() <= borneHaute) {
                            Date d = entrerDate("Date du Agence.RDV");
                ...
                if (p.getBienSoumis().indexOf(b) == -1) {
                    ...
                    if (a.getLocalistation().equals(v.getLocalisation()) && a.getNbPieces() == v.getNbPieces()) {
                        ...
                        if (a.getPrix() >= borneBasse && a.getPrix() <= borneHaute) {
                            ...
                            Date d = entrerDate("Date Agence.RDV Visite");
                            p.getBienSoumis().add(b);
                            this.prendreRDVVisite(p, b, d);
                        }
                    }
    ...
    /**
     * inscrit une personne Personne.Morale pour la vente d un appartement.
     * Ajoute la personne a la liste des vendeurs le terrain dans la liste des bien et creer un rdv pour signer un mandat et l ajoute a la liste des Agence.RDV
     *
     * @param nom                  nom de la personne morale
     * @param adresse              adresse de la personne morale
