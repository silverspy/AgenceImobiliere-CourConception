...
/**
 * Classe Agence.RDV.Un rendez vous peut etre un mandat,une visite ou un rendez vous de vente.
...
public class RDV {
    ...
    /**
     * Initialise un Agence.RDV  de vente avec les parametres suivants
     *
        ...
        switch (typeRdv) {
            ...
            case "Vente":
                if (vend == null || achet == null) {
                    ...
                    System.out.println("on organise un Agence.RDV pour signer la vente");
                }
                break;
        ...
        switch (typeRdv) {
            ...
            case "Agence.Mandat":
                if (vendeur == null) {
                    ...
                    System.out.println("on organise un Agence.RDV pour signer le mandat");
                    this.dateRDV = d;
                    this.bien = b;
        ...
        switch (typeRdv) {
            ...
            case "Visite":
                if (acheteur == null || b == null) {
                    ...
                    System.out.println("on organise un Agence.RDV pour visiter");
                    this.dateRDV = d;
                    this.bien = b;
    ...
    /**
     * getteur de la date du Agence.RDV
     *
     * @return dateRDV
     */
    Date getDateRDV() {
    ...
    /**
     * getteur du bien concerné par le Agence.RDV
     *
     * @return bien
     */
    ...
    /**
     * getteur de la liste de personne concerné par le Agence.RDV
     *
     * @return lsPersonne
     */
    ...
    /**
     * setteur de la date du Agence.RDV
     *
    ...
    /**
     * setteur du bien concerné par le Agence.RDV
     *
    ...
    public String toString() {
        return "Agence.RDV" + this.typeRdv;
    }
}
